  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "gap-4 border border-border bg-card p-6 shadow-xl rounded-xl",
...
const DialogHeader = ({
  ...
  <div
    className={cn(
      "flex flex-col space-y-1.5 text-right pb-4 border-b border-border",
      className
    )}
    {...props}
  />
...
const DialogFooter = ({
  ...
  <div
    className={cn(
      "flex flex-col-reverse sm:flex-row sm:justify-start sm:gap-2 pt-4 border-t border-border",
      className
    )}
    {...props}
  />
